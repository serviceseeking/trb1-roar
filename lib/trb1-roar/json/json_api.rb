      ...
      module JSONAPI
        ...
        module ForCollection
          def collection_representer # FIXME: cache.
            ...
            nested_builder.(_base: default_nested_class, _features: [Trb1::Roar::JSON, Trb1::Roar::Hypermedia], _block: Proc.new do
        ...
        module Declarative
          ...
          def meta(&block)
            representable_attrs[:meta_representer] = Class.new(Trb1::Roar::Decorator, &block)
          end
          ...
          def has_one(name, options={}, &block)
            ...
            nested(:included, inherit: true) do
              dfn = property(name, collection: options[:collection]) do
                include Trb1::Roar::JSON::JSONAPI
                include Trb1::Roar::JSON
                include Trb1::Roar::Hypermedia
        ...
        private
          ...
          def render_meta(options)
            ...
            {"meta" => representer.new(represented).extend(Trb1::Representable::Hash).to_hash}
          end
